...
export default function NavBar() {
  ...
  return (
    <div className=" bg-transparent border-white border-opacity-40 md:shadow-none shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sticky top-0 z-10 flex justify-between items-center p-3 lg:p-4 lg:px-20 px-7 lg:pt-8 min-h-[4.2rem] ">
      ...
      <motion.div
        className="flex fixed top-[1.0rem] w-[3.1rem] px-1  rounded-full lg:hidden left-7"
      ...
      <motion.div
        className="flex fixed top-[1.1rem] right-6 lg:hidden z-[999] "
          ...
          <div className="  pt-20">
            ...
            <div className="flex justify-center mt-2">
              <a href="#about">
                <Button
                  variant="outline"
                  className=" display: block  py-2 w-[20rem] "
                  onClick={() => setShowMenu(!showMenu)}
                >
                  {" "}
                  About{" "}
